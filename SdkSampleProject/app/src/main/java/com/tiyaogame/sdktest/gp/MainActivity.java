package com.tiyaogame.sdktest.gp;
...
import com.tiyaogame.sdk.api.data.PayData;
import com.tiyaogame.sdk.api.data.UserPrefs;
import com.tiyaogame.sdk.api.setting.TiYaoSdkSetting;
import com.tiyaogame.sdk.login.SdkLoginListener;
import com.tiyaogame.sdk.login.SdkLogoutListener;
import com.tiyaogame.sdk.pay.PurchaseInAppListener;
import com.tiyaogame.sdk.pay.TiYaoPayMgr;
import com.tiyaogame.sdktest.R;

import java.util.Map;

import static com.tiyaogame.sdk.login.TiYaoLoginMgr.*;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void reportEvent(String json)
    {
        ...
        String gameOrderId =  map1.get(UserPrefs.gameOrderId).toString();
